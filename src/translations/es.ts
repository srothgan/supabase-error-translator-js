...
export default {
  ...
  services: {
    ...
    auth: {
      ...
      email_address_invalid: 'Dirección de correo electrónico no válida.',
      ...
      flow_state_expired: 'El estado PKCE ha expirado. Por favor, vuelva a iniciar sesión.',
      flow_state_not_found: 'El estado PKCE no existe. Por favor, vuelva a iniciar sesión.',
    ...
    database: {
      ...
      PGRST300: 'Se produjo un error durante una inserción o actualización masiva.',
