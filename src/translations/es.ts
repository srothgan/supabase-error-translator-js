...
export default {
  ...
  anonymous_provider_disabled:
    "Los inicios de sesión anónimos están deshabilitados.",
  ...
  email_address_not_authorized:
    "No está permitido enviar correos a esta dirección.",
  ...
  flow_state_expired:
    "El estado PKCE ha expirado. Por favor, vuelve a iniciar sesión.",
  flow_state_not_found:
    "El estado PKCE no existe. Por favor, vuelve a iniciar sesión.",
  hook_payload_invalid_content_type:
    "El payload del hook tiene un Content-Type inválido.",
  ...
  over_email_send_rate_limit:
    "Demasiados correos enviados – espera un momento.",
  ...
  provider_email_needs_verification:
    "Se requiere verificar el correo tras OAuth.",
  ...
  saml_relay_state_expired:
    "El relay state SAML expiró. Vuelve a iniciar sesión.",
  saml_relay_state_not_found:
    "Relay state SAML no encontrado. Vuelve a iniciar sesión.",
  session_expired: "Sesión expirada.",
  session_not_found: "Sesión no encontrada.",
  signup_disabled: "Registro deshabilitado.",
  single_identity_not_deletable:
    "Debe permanecer al menos una identidad vinculada.",
