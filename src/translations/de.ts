...
export default {
  ...
  bad_code_verifier:
    "Der Code-Verifier stimmt nicht mit dem erwarteten überein.",
  bad_json: "Der Anfragekörper ist kein gültiges JSON.",
  bad_jwt: "Das JWT im Authorization-Header ist ungültig oder abgelaufen.",
  bad_oauth_callback:
    "Der OAuth-Callback enthält nicht alle erforderlichen Attribute.",
  ...
  email_address_not_authorized:
    "E-Mail-Versand für diese Adresse ist nicht erlaubt.",
  ...
  flow_state_expired:
    "Der PKCE-Flow-State ist abgelaufen. Bitte erneut anmelden.",
  flow_state_not_found:
    "Der PKCE-Flow-State wurde nicht gefunden. Bitte erneut anmelden.",
  hook_payload_invalid_content_type:
    "Hook-Payload hat einen ungültigen Content-Type.",
  hook_payload_over_size_limit:
    "Hook-Payload überschreitet die maximale Größe.",
  hook_timeout: "Hook konnte nicht innerhalb der Zeit erreicht werden.",
  hook_timeout_after_retry:
    "Hook konnte auch nach Wiederholungen nicht erreicht werden.",
  ...
  manual_linking_disabled:
    "Manuelles Verknüpfen von Identitäten ist deaktiviert.",
  mfa_challenge_expired:
    "Die MFA-Challenge ist abgelaufen. Bitte erneut anfordern.",
  mfa_factor_name_conflict:
    "Es existiert bereits ein MFA-Faktor mit diesem Namen.",
  ...
  mfa_web_authn_enroll_not_enabled:
    "WebAuthn-MFA-Registrierung ist deaktiviert.",
  mfa_web_authn_verify_not_enabled:
    "WebAuthn-MFA-Verifizierung ist deaktiviert.",
  ...
  over_email_send_rate_limit:
    "Zu viele E-Mails gesendet – bitte warten und erneut versuchen.",
  over_request_rate_limit: "Zu viele Anfragen – bitte kurz warten.",
  over_sms_send_rate_limit:
    "Zu viele SMS gesendet – bitte warten und erneut versuchen.",
  phone_exists: "Telefonnummer existiert bereits.",
  phone_not_confirmed:
    "Anmeldung nicht erlaubt – Telefonnummer ist nicht bestätigt.",
  ...
  provider_email_needs_verification:
    "Nach OAuth-Flow muss die E-Mail bestätigt werden.",
  reauthentication_needed: "Erneute Authentifizierung erforderlich.",
  reauthentication_not_valid:
    "Erneute Authentifizierung fehlgeschlagen. Falscher Code.",
  ...
  saml_entity_id_mismatch:
    "Die Entity-ID stimmt nicht mit der bestehenden überein.",
  ...
  saml_relay_state_expired:
    "SAML-Relay-State abgelaufen. Bitte erneut anmelden.",
  saml_relay_state_not_found:
    "SAML-Relay-State nicht gefunden. Bitte erneut anmelden.",
  ...
  single_identity_not_deletable:
    "Mindestens eine Identität muss vorhanden bleiben.",
